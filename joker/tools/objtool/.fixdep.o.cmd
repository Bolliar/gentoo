# cannot find fixdep (/usr/src/linux-5.10.7-gentoo/tools/objtool//fixdep)
# using basic dep data

/usr/src/linux-5.10.7-gentoo/tools/objtool/fixdep.o: fixdep.c \
...
cmd_/usr/src/linux-5.10.7-gentoo/tools/objtool/fixdep.o := gcc -Wp,-MD,/usr/src/linux-5.10.7-gentoo/tools/objtool/.fixdep.o.d -Wp,-MT,/usr/src/linux-5.10.7-gentoo/tools/objtool/fixdep.o -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer -std=gnu89   -D"BUILD_STR(s)=$(pound)s"   -c -o /usr/src/linux-5.10.7-gentoo/tools/objtool/fixdep.o fixdep.c
